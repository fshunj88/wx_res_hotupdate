window.__require = function e(t, n, r) {
  ...
  GameLogic: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "a87360wp7lAKrqgHEx1sURR", "GameLogic");
    "use strict";
    ...
    (function(Collection) {
      ...
      function defaultToString(item) {
        return null === item ? "COLLECTION_NULL" : isUndefined(item) ? "COLLECTION_UNDEFINED" : isString(item) ? "$s" + item : "$o" + item.toString();
      }
      Collection.defaultToString = defaultToString;
      function makeString(item, join) {
        void 0 === join && (join = ",");
        if (null === item) return "COLLECTION_NULL";
        if (isUndefined(item)) return "COLLECTION_UNDEFINED";
        if (item instanceof String || item instanceof Number) return item.toString();
        var toret = "{";
        var first = true;
        for (var prop in item) if (Collection.has(item, prop)) {
          first ? first = false : toret += join;
      ...
      function reverseCompareFunction(compareFunction) {
        return isUndefined(compareFunction) || !isFunction(compareFunction) ? function(a, b) {
          return a < b ? 1 : a === b ? 0 : -1;
        } : function(d, v) {
          return -1 * compareFunction(d, v);
        };
      }
    ...
    (function(Collection) {
      function indexOf(array, item, equalsFunction) {
        ...
        var i = 0;
        for (;i < length; i++) if (equals(array[i], item)) return i;
        return -1;
      }
      ...
      function lastIndexOf(array, item, equalsFunction) {
        ...
        var length = array.length;
        var i = length - 1;
        for (;i >= 0; i--) if (equals(array[i], item)) return i;
        return -1;
      }
      ...
      function frequency(array, item, equalsFunction) {
        ...
        var freq = 0;
        var i = 0;
        for (;i < length; i++) equals(array[i], item) && freq++;
        return freq;
      }
      ...
      function equals(array1, array2, equalsFunction) {
        ...
        var i = 0;
        for (;i < length; i++) if (!equals(array1[i], array2[i])) return false;
        return true;
      }
    ...
    (function(Collection) {
      function defaultDictionaryToString(item) {
        return null === item ? "COLLECTION_NULL" : Collection.isUndefined(item) ? "COLLECTION_UNDEFINED" : Collection.isString(item) ? "$s" + item : "$o" + item.toString();
      }
      ...
      var Dictionary = function() {
        ...
        Dictionary.prototype.getValue = function(key) {
          ...
          if (Collection.isUndefined(pair)) return;
          return pair.value;
        };
        Dictionary.prototype.setValue = function(key, value) {
          if (Collection.isUndefined(key) || Collection.isUndefined(value)) return;
          var ret;
        ...
        Dictionary.prototype.keys = function() {
          var array = [];
          var name = void 0;
          for (name in this.table) if (Collection.has(this.table, name)) {
            var pair = this.table[name];
            void 0 !== pair && array.push(pair.key);
          }
          return array;
        };
        Dictionary.prototype.values = function() {
          ...
          for (name in this.table) if (Collection.has(this.table, name)) {
            var pair = this.table[name];
            void 0 !== pair && array.push(pair.value);
          }
          return array;
        };
        Dictionary.prototype.forEach = function(callback) {
          var name = void 0;
          for (name in this.table) if (Collection.has(this.table, name)) {
            if (void 0 == this.table[name]) continue;
            var pair = this.table[name];
    ...
    (function(Collection) {
      ...
      var LinkedDictionary = function(_super) {
        ...
        LinkedDictionary.prototype.getLinkedDictionaryPair = function(key) {
          if (Collection.isUndefined(key)) return;
          var k = "$" + this.toStr(key);
        ...
        LinkedDictionary.prototype.getValue = function(key) {
          ...
          if (!Collection.isUndefined(pair)) return pair.value;
          return;
        };
      ...
      var List = function() {
        ...
        List.prototype._insert = function(obj, prev, next) {
          if (this._objMap.containsKey(obj)) {
            if (obj == prev.obj || obj == next.obj) return;
        ...
        List.prototype.push = function(obj, after) {
          var entry = null;
          after && (entry = this._objMap.getValue(after));
          entry || (entry = this._head.prev);
          this._insert(obj, entry, entry.next);
        };
        List.prototype.pushFront = function(obj, before) {
          var entry = null;
          before && (entry = this._objMap.getValue(before));
          entry || (entry = this._head.next);
        ...
        List.prototype.remove = function(obj) {
          var elem = this._objMap.getValue(obj);
          elem && this._remove(elem);
        };
        List.prototype.forEach = function(func, reverse) {
          void 0 === reverse && (reverse = false);
          if (reverse) for (var entry = this._head.prev; entry != this._head; entry = entry.prev) func(entry.obj); else for (var entry = this._head.next; entry != this._head; entry = entry.next) func(entry.obj);
        };
      ...
      var LruCache = function() {
        ...
        LruCache.prototype.use = function(obj) {
          ...
          if (!this._keyToObj[key]) {
            ...
            this._size++;
            this._size > this._maxSize && this._tidy(this._size - this._maxSize);
          }
        };
        ...
        LruCache.prototype.clear = function(destroy) {
          ...
          this._size = 0;
          this._keyToObj = {};
          destroy && this._lruList.forEach(function(obj) {
    ...
    (function(Collection) {
      var MultiDictionary = function() {
        function MultiDictionary(toStrFunction, valuesEqualsFunction, allowDuplicateValues) {
          void 0 === allowDuplicateValues && (allowDuplicateValues = false);
        ...
        MultiDictionary.prototype.getValue = function(key) {
          ...
          if (Collection.isUndefined(values)) return [];
          return Collection.copy(values);
        };
        MultiDictionary.prototype.setValue = function(key, value) {
          if (Collection.isUndefined(key) || Collection.isUndefined(value)) return false;
          var array = this.dict.getValue(key);
          if (Collection.isUndefined(array)) {
            this.dict.setValue(key, [ value ]);
            return true;
          }
          if (!this.allowDuplicate && Collection.contains(array, value, this.equalsF)) return false;
          array.push(value);
          return true;
        };
        MultiDictionary.prototype.remove = function(key, value) {
          ...
          if (!Collection.isUndefined(array) && Collection.remove(array, value, this.equalsF)) {
            0 === array.length && this.dict.remove(key);
            return true;
          }
          return false;
        };
    ...
    (function(Collection) {
      var Set = function() {
        ...
        Set.prototype.add = function(element) {
          if (this.contains(element) || Collection.isUndefined(element)) return false;
        ...
        Set.prototype.intersection = function(otherSet) {
          ...
          this.forEach(function(element) {
            otherSet.contains(element) || set.remove(element);
            return true;
          });
        };
      ...
      var MiniGameHotUpdateMgr = function() {
        function MiniGameHotUpdateMgr() {
          ...
          if (Core.DeviceUtils.isWXGame()) {
            ...
            if (!Core.DeviceUtils.isTTGame()) throw Error("\u5176\u4ed6\u7c7b\u578b\u7684\u5c0f\u6e38\u620f\u8bf7\u5728DeviceUtils\u4e2d\u652f\u6301\u5224\u5b9a\u63a5\u53e3\uff01");
          ...
          if (cachedVersion) {
            ...
            this._cachedVerCompareToPackVerRet > 0 && (this._localVersion = cachedVersion);
          }
        }
        Object.defineProperty(MiniGameHotUpdateMgr, "inst", {
          get: function get() {
            this._inst || (this._inst = new MiniGameHotUpdateMgr());
            return this._inst;
          },
          enumerable: false,
          configurable: true
        ...
        MiniGameHotUpdateMgr.prototype._saveVersionToCache = function(v) {
          ...
          var localVersion = {};
          localVersionStr && "" != localVersionStr && (localVersion = JSON.parse(localVersionStr));
          localVersion[this._buildType] || (localVersion[this._buildType] = {});
        ...
        MiniGameHotUpdateMgr.prototype._getVersionFromCache = function() {
          ...
          if (localVersionStr && "" != localVersionStr) {
            ...
            localVersion[this._buildType] && localVersion[this._buildType][this._subType] && (cachedVersion = localVersion[this._buildType][this._subType]);
          }
            ...
            return __generator(this, function(_a) {
              switch (_a.label) {
               ...
               case 3:
                ret2 = _a.sent();
                if (ret2.isSuccess()) {
                  this._observer && this._observer.onDownloadDone && this._observer.onDownloadDone(ret.errcode, ret2.errorMessage());
                ...
                return [ 2, {
                  success: false,
                  reason: ret2.errorMessage()
                } ];

               case 4:
                return [ 2, {
                  success: false,
                  reason: ret1.errorMessage()
                } ];
               ...
               case 6:
                if (this._cachedVerCompareToPackVerRet > 0) return this._loadSettingsFromCached() ? [ 2, {
                  success: true
                } ] : [ 2, {
                  success: false,
                  reason: "\u8d44\u6e90\u9519\u8bef\uff0c\u8bf7\u70b9\u51fb\u6e05\u7406\u6309\u94ae\u6e05\u7406\u8d44\u6e90\uff01"
                } ];
                0 == remoteVerCompareToLocalVerRet;
                return [ 2, {
                  success: true
                } ];
        ...
        MiniGameHotUpdateMgr.prototype._checkVersion = function() {
          return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_a) {
              switch (_a.label) {
               case 0:
                this._observer && this._observer.onCheckVersion && this._observer.onCheckVersion();
               ...
               case 1:
                ret = _a.sent();
                this._observer && this._observer.onCheckVersionDone && this._observer.onCheckVersionDone(ret.errcode, ret.errorMessage());
                return [ 2, ret ];
              }
            });
          });
              ...
              switch (_a.label) {
               case 0:
                ...
                return [ 4, this._fs.loadRemoteImportZipFile(fileName, function(res) {
                  self._observer && self._observer.onDownloadProgress && self._observer.onDownloadProgress(res.totalBytesWritten, res.totalBytesExpectedToWrite);
                }) ];

               case 1:
                ret = _a.sent();
                downloadRet = new HotUpdate.DownloadPatchRet();
                downloadRet.errcode = ret ? 0 : 3002;
        ...
        MiniGameHotUpdateMgr.prototype._initAssetLibrary = function(settings) {
          if (!settings.debug) {
            ...
            for (var _c = 0, packedAssetsKeys_1 = packedAssetsKeys; _c < packedAssetsKeys_1.length; _c++) {
              ...
              for (;j < length; ++j) "number" == typeof packedIds[j] && (packedIds[j] = uuids[packedIds[j]]);
            }
            ...
            for (var s in r) for (var obj = r[s], n = 0; n < obj.length; n += 2) "number" == typeof i[n] && (i[n] = t[i[n]]);
            var subpackages = settings.subpackages;
            for (var subId in subpackages) {
              var uuidArray = subpackages[subId].uuids;
              if (uuidArray) for (var k = 0, l = uuidArray.length; k < l; k++) "number" === typeof uuidArray[k] && (uuidArray[k] = uuids[uuidArray[k]]);
            }
          }
          var options = {
          ...
          md5Pipe && cc.loader.removePipe(md5Pipe);
        ...
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
             case 0:
              namespace = wx;
              Core.DeviceUtils.isTTGame() && (namespace = tt);
              if (void 0 == namespace.getUpdateManager) return [ 2 ];
              r = null;
              return [ 4, new Promise(function(resolve) {
                r = resolve;
                ...
                updateManager.onCheckForUpdate(function(res) {
                  ...
                  if (res.hasUpdate) updateLoadingHint("\u68c0\u6d4b\u5230\u65b0\u7684\u7248\u672c\uff0c\u6b63\u5728\u4e0b\u8f7d\uff0c\u8bf7\u7a0d\u5019..."); else {
                    updateLoadingHint("");
                    resolveCheck();
                  }
                });
                updateManager.onUpdateReady(function() {
                  ...
                  namespace.showModal({
                    ...
                    success: function success(res) {
                      res.confirm ? updateManager.applyUpdate() : resolveCheck();
                    },
                ...
                Core.DeviceUtils.isTTGame() && resolveCheck();
              }) ];
    ...
    var Entry = function() {
      ...
      Object.defineProperty(Entry, "inst", {
        get: function get() {
          null == this._inst && (this._inst = new Entry());
          return this._inst;
        },
        enumerable: false,
        configurable: true
    ...
    var Test = function() {
      ...
      Object.defineProperty(Test, "inst", {
        get: function get() {
          null == this._inst && (this._inst = new Test());
          return this._inst;
        },
        enumerable: false,
        configurable: true
    ...
    var TestHotUpdate = function() {
      ...
      Object.defineProperty(TestHotUpdate, "inst", {
        get: function get() {
          null == this._inst && (this._inst = new TestHotUpdate());
          return this._inst;
        },
        enumerable: false,
        configurable: true
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
             case 0:
              ...
              btn && btn.on(cc.Node.EventType.TOUCH_END, function() {
    ...
    var TestMiniGame = function() {
      ...
      Object.defineProperty(TestMiniGame, "inst", {
        get: function get() {
          null == this._inst && (this._inst = new TestMiniGame());
          return this._inst;
        },
        enumerable: false,
        configurable: true
        ...
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
             ...
             case 3:
              _a.sent() ? console.log("aaa \u76ee\u5f55 \u5b58\u5728\u4e8e\u672c\u5730\u7528\u6237\u76ee\u5f55") : console.log("aaa \u76ee\u5f55 \u4e0d\u5b58\u5728");
          ...
          return __generator(this, function(_a) {
            ...
            return [ 2, new Promise(function(resolve, reject) {
              fs.readdir({
                dirPath: "" + path,
                success: function success(res) {
                  console.log("success to list dir:" + path + "---\x3e", res.files);
                  resolve();
                },
                fail: function fail(err) {
            ...
            return [ 2, new Promise(function(resolve, reject) {
              ...
              var success = function success(res) {
                ...
                FileSystemManager.readFile({
                  ...
                  encoding: "utf8",
                  success: function success(res) {
                    console.log(filePath + " \u5185\u5bb9\u662f--\x3e", res.data);
                    resolve();
                  },
                  fail: function fail(err) {
            ...
            return [ 2, new Promise(function(resolve, reject) {
              ...
              var success = function success(res) {
                ...
                FileSystemManager.readFile({
                  ...
                  encoding: "utf8",
                  success: function success(res) {
                    console.log("kk/tmp.txt is:--\x3e", res.data);
                    resolve();
                  },
                  fail: function fail(err) {
          ...
          return __generator(this, function(_a) {
            ...
            return [ 2, new Promise(function(resolve, reject) {
              ...
              var option = {
                url: url,
                success: function success(v) {
                  if (v.statusCode >= 400) reject(null); else {
    ...
    (function(WXGame) {
      var WXFileSystem = function() {
        function WXFileSystem() {
          ...
          Core.DeviceUtils.isQQPlay() ? this._fs = qq.getFileSystemManager() : this._fs = wx.getFileSystemManager();
        ...
        Object.defineProperty(WXFileSystem, "inst", {
          get: function get() {
            WXFileSystem._inst || (WXFileSystem._inst = new WXFileSystem());
        ...
        WXFileSystem.prototype.restartGame = function() {
          wx.restartMiniProgram ? wx.restartMiniProgram() : this.exitGame();
        };
          ...
          return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_a) {
              switch (_a.label) {
               ...
               case 2:
                _a.sent() || console.error("can't init file version info");
                _a.label = 3;
               ...
               case 4:
                infoStr = _a.sent();
                infoStr ? this._fsCachePathInfo = JSON.parse(infoStr) : console.error("can't read file version info");
                return [ 2 ];
              }
            });
          });
            ...
            return __generator(this, function(_a) {
              switch (_a.label) {
               case 0:
                ...
                this._fsCachePathInfo[extName] || (this._fsCachePathInfo[extName] = {});
        ...
        WXFileSystem.prototype.isRemotePath = function(p) {
          return 0 == p.indexOf("http://") || 0 == p.indexOf("https://");
        };
        ...
        WXFileSystem.prototype.itemExistsInCache = function(item, localPath) {
          ...
          if (!this._fsCachePathInfo[extName]) return false;
        ...
        WXFileSystem.prototype.readFile = function(p, encoding, withRootDir) {
          void 0 === withRootDir && (withRootDir = true);
          return __awaiter(this, void 0, void 0, function() {
            var path;
            var _this = this;
            return __generator(this, function(_a) {
              switch (_a.label) {
               case 0:
                path = p;
                withRootDir && (path = this._fsRoot + p);
                return [ 4, new Promise(function(resolve) {
                  _this._fs.readFile({
                    filePath: path,
                    encoding: encoding,
            ...
            return __generator(this, function(_a) {
              switch (_a.label) {
               case 0:
                ...
                if (withRootDir) {
                  path = this._fsRoot + p;
                  console.log("unlink:---\x3epath:", path);
                }
                return [ 4, new Promise(function(resolve) {
                  _this._fs.unlink({
                    filePath: path,
               ...
               case 0:
                p = new Promise(function(resolve, reject) {
                  var options = {
                    url: url,
                    success: function success(v) {
                      v.statusCode >= 400 ? retryCnt <= 0 ? reject("\u52a0\u8f7d\u5931\u8d25\uff1a" + url + "[" + v.statusCode + "]") : resolve(null) : resolve(v);
                    },
                    fail: function fail(e) {
                  ...
                  target && "" != target && (options["filePath"] = _this._fsRoot + target);
                  if (Core.DeviceUtils.isQQPlay()) {
                    var task = qq.downloadFile(options);
                    progressCb && task.onProgressUpdate(function(res) {
                      progressCb(res);
                    });
                  } else {
                ...
                return [ 4, new Promise(function(resolve, reject) {
                  ...
                  xhr.onload = function() {
                    if (xhr.status >= 400) {
                      ...
                      resolve("");
                    } else resolve(isText ? xhr.responseText : xhr.response);
                  };
      ...
      var CocosWXDownloader = function() {
        ...
        Object.defineProperty(CocosWXDownloader, "inst", {
          get: function get() {
            null == CocosWXDownloader._inst && (CocosWXDownloader._inst = new CocosWXDownloader());
        ...
        CocosWXDownloader.prototype.handle = function(item, callback) {
          ...
          if ("uuid" === item.type) {
            ...
            if (void 0 !== result) return result || void 0;
          }
          ...
          WXFileSystem.inst.wxFs.access({
            path: filePath,
            success: function success() {
              item.type && -1 !== non_text_format.indexOf(item.type) ? self.nextPipe(item, callback) : self.readTextFile(item, callback);
            },
            fail: function fail(res) {
        ...
        CocosWXDownloader.prototype.ensureDirFor = function(path, callback) {
          ...
          if ("wxfile://usr" === ensureDir || "http://usr" === ensureDir) {
            callback();
            return;
          }
          var self = this;
        ...
        CocosWXDownloader.prototype.downloadRemoteFile = function(item, callback) {
          ...
          this._downloadFile(remoteUrl, function(success, res) {
            if (success) {
              ...
              if (WXGame.uncachedFileUuids.indexOf(uuid_1) < 0) self.ensureDirFor(localPath, function() {
        ...
        CocosWXDownloader.prototype.readTextFile = function(item, callback) {
          ...
          for (var i = 0; i < binary_format.length; i++) if (url.endsWith(binary_format[i])) {
            encodingFormat = "";
            break;
          }
          var fs = WXFileSystem.inst.wxFs;
