...
declare const wx: {
    ...
    onShareTimeline(callback: ()=>void): void;
    /**
     * 取消监听用户点击右上角菜单的“转发”按钮时触发的事件
     */
    offShareAppMessage(callback: ()=>void): void;
    showShareMenu(object: {withShareTicket:boolean,menus?:Array<string>,success?:(res:any)=>void,fail?:(res:any)=>void,complete?:(res:any)=>void}): void;
    /**
     * 主动拉起转发，进入选择通讯录界面。
     */
...
declare interface GameRecorder {
     ...
     * 开始录制游戏画面。
     * @param {Object} object 
     * @param {number} [object.fps = 24] 视频 fps
     * @param {number} [object.duration = 600] 游戏画面的录制时长，单位为秒（s）。最大值 600，最小值 5，到达指定时间时会自动停止录制。
     * @param {number} [object.bitrate = 1000] 视频比特率（kbps
     * @param {number} [object.gop = 12] 视频关键帧间隔
     */
    start(obj: Object): Promise<any>;
    /**
